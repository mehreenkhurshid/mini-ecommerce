                ...
                <div className="grid md:grid-cols-2 items-center gap-10 py-16 max-w-6xl mx-auto">
                    <div className="space-y-6 text-center md:text-left md:ml-0 ml-2">
                        ...
                        <p className="text-gray-600 max-w-md mx-auto md:mx-0">
                            ...
                            Experience smooth online shopping like never before.
                        </p>
            ...
            <div className="mt-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl mx-auto px-6">
                    {featuredProducts.map((product) => (
                        <div
                            key={product.id}
                            className="border rounded-xl p-6 shadow hover:shadow-lg transition text-center bg-rose-100"
                        >
                            <img
                                src={product.img}
                                alt={product.name}
                            ...
                            <button
                                ...
                                className="mt-4 px-4 py-2 bg-rose-500 text-white rounded-md hover:bg-rose-400 transition"
                            >
                                Add to Cart
                            </button>
                        </div>
            ...
            <div className="mt-16 bg-rose-50 py-12 shadow-inner">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 items-center gap-10 px-6">
                    ...
                    <div className="space-y-4 text-center md:text-left">
                        ...
                        <p className="text-gray-600 max-w-md mx-auto md:mx-0">
                            Boost your productivity with the latest generation
                            laptop featuring sleek design, high speed
